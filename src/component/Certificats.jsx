...
function Certification() {
  const office = (
    <img alt="Card" src={require('../images/Cert9792259747.jpg')} style={{ heigh:'250px' }} />
  );
  const react = (
    <img alt="Card" src={require('../images/Coursera FullStackWeb.jpg')} style={{ height:'250px' }} />
  );  
  const devops = (
    <img alt="Card" src={require('../images/Devops.jpg')} style={{ height:'250px'}} />
  );
  return (
